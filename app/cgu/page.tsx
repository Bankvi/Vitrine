...
export default function CguPage() {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-[#1A0F05] via-[#0D0D0D] to-[#1A0F05]">
      {/* Orbe décoratif */}
      <div className="absolute top-0 right-0 w-96 h-96 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob animation-delay-4000 pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(60,30,10,0.6) 0%, transparent 70%)' }}></div>
